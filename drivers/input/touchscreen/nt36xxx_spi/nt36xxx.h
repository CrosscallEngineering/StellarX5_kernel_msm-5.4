 ...
 *
 * $Revision: 91230 $
 * $Date: 2021-11-22 18:23:49 +0800 (Mon, 22 Nov 2021) $
 *
...
#define CONFIG_TOUCHSCREEN_NT36XXX_GESTURE 1
#define CONFIG_TOUCHSCREEN_NT36XXX_GLOVE 1
#define CONFIG_NVT_INCELL_CHIP 1
#define CONFIG_TOUCHSCREEN_WORK_MODE 1
...
#define BOOT_UPDATE_FIRMWARE_NAME "novatek_ts_fw_l780.bin"
...
struct nvt_ts_data {
	...
	struct delayed_work nvt_product_register_work;
...
#ifdef CONFIG_TOUCHSCREEN_NT36XXX_HALL
	bool hall_enable;
#endif
	bool resume_is_running;//hmct add for TP async use

	bool need_poweroff;
    //add nvt_point_data, 20190130
	uint8_t nvt_point_data[POINT_DATA_LEN + 1];
	uint8_t *rbuf;
	uint8_t *xbuf;
...
extern struct spi_device *NT_Client;
...
//extern int32_t nvt_glove_enable(uint8_t);
